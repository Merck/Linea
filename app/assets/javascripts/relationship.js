...
(function () {
    var a = 800, c = 800, h = c, U = 200, K = 22, S = 20, s = 8, R = 110, J = 30, o = 15, t = 10, w = 1000, F = "elastic", N = "#0da4d3"; var T, q, x, j, H, A, P;
    var L = {}, k = {};
    var i, y;
    ...
    function G(Y, X) {
        ...
        L.node.children.forEach(function(ac) {
            ...
            ac._children.forEach(function(ad) {
                ad.canonicalKey = ad.key; ad.key = ac.key + "-" + ad.key;
                L.map[ad.key] = true;
            });
    ...
    function b(X) {
        ...
        X.transition().duration(w).ease(F).attr("transform", function(Z) {
            if (Z === L.node) { return null; } var aa = Z.isGroup ? Z.y + (7 + Z.count) : Z.y;
            ...
            if (ab && ab.type === "theme") {
                ...
                if (ab && ab.type === "perspective") {
                    ...
                    ad.enter().append("text").attr("fill", "#aaa").attr("text-anchor", "middle").attr("y", function(af, ae) {
                        ...
                        return "(vs. " + ae.name + ")";
                    }).attr("class", "pair").on("click", G); Y.append("text").attr("fill", "#aaa").attr("text-anchor", "middle").attr("y", (o + t) * -1).text("PERSPECTIVE");
                    ad.exit().remove();
                }
            }
        }
    ...
    function z() {
        ...
        E.selectAll("circle").attr("fill", function(X) {
            ...
            } else { if (X.type === "theme" || X.type === "perspective") {
                return 1.5;
            }
            }
            return null;
